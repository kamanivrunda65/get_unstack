            ...
            <div class="col-lg-6 mr-auto">
                <div class="hero-content">
                    ...
                    <div class="hero-btn-box pt-30px">
                        ...
                        <a href="#for-businesses" class="btn theme-btn text-white page-scroll">For businesses <i class="la la-angle-down icon ml-1"></i></a>
                    </div>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <a href="home-2.html" class="btn text-white theme-btn">Browse questions <i class="la la-arrow-right icon ml-1"></i></a>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half ">
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text pb-4">This is just a simple text made for this unique and awesome template, you can easily edit it as you want.</p>
                        <a href="free-demo.html" class="btn text-white theme-btn ">Try for free <i class="la la-arrow-right icon ml-1"></i></a>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
