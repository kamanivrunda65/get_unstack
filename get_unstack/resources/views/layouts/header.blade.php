                        ...
                        <div class="col-lg-9">
                            <h2>
                                <ul class="breadcrumb-list pt-20px pb-15  fs-15">
                                    ...
                                    <a href="addpost"><li class="text-white"><i class="la la-pencil mr-1"></i>ADD POST |</li></a>
...
<!--======================================
                    ...
                    <nav class="menu-bar ml-auto pr-2 ">
                        <ul>
                            ...
                            <li class="is-mega-menu pl-30px">
                                <a href="{{route('layouts.askquestion')}}" class="text-white">ASK QUESTION</a>

                            </li>
                            <li class="is-mega-menu pl-30px">
                                <a href="{{route('layouts.question')}}" class=" text-white">QUESTION</a>
                            ...
                            <li class="dropdown user-dropdown pl-30px">
                                ...
                                <ul class="dropdown-menu-item text-dark">
                                    ...
                                    <div class="dropdown-divider border-top-gray mb-0"></div>
                                        ...
                                        <a class="dropdown-item" href="profile"><li><i class="la la-user mr-2"></i> Profile</li></a>
                                        <a class="dropdown-item" href="notification"><li><i class="la la-bell mr-2"></i> Notifications</li></a>
                                        <a class="dropdown-item" href="referrals"><li><i class="la la-user-plus mr-2"></i> Referrals</li></a>
                                        <a class="dropdown-item" href="setting"><li><i class="la la-gear mr-2"></i> Settings</li></a>
    ...
    <div class="off-canvas-menu custom-scrollbar-styled">
        ...
        <ul class="generic-list-item off-canvas-menu-list pt-90px text-blue">
            ...
            <li><a href="addpost"><i class="la la-pencil mr-1 fs-20 pb-20px">ADD POST</i></a></li>


            <li><a href="login"> <i class="la la-sign-in mr-1 fs-20 pb-20px"> LOGIN</i></a></li>
            <li><a href="signup"><i class="la la-plus-circle mr-1 fs-20 pb-20px"> SIGN UP</i></a></li>

            <li><a href="contact"><i class="la la-phone mr-1 fs-20 pb-20px"> CONTACT</i></a></li>
        </ul>
            <hr>
        <ul class="generic-list-item off-canvas-menu-list text-blue ml-20px">
            <li  class="fs-20 pb-20px">
                <a href="home"><i class="la la-home mr-1 fs-20 "> HOME</i></a>

            </li>
            <li class="fs-20 pb-20px">
                <a href="askquestion"><i class="la la-edit mr-1 fs-20 "> ASK QUESTION</i></a>

            </li>
            <li class="fs-20 pb-20px">
                <a href="question"><i class="la la-question-circle mr-1 fs-20 "> QUESTION</i></a>

            </li>
            <li class="fs-20 pb-20px">
                <a href="blog"><i class="la la-comment mr-1 fs-20 "> BLOG</i></a>
        ...
        <div class="tab-content pt-3" id="myTabContent2">
            <div class="tab-pane fade show active" id="user-notification-menu" role="tabpanel" aria-labelledby="user-notification-menu-tab">
                <div class="dropdown--menu shadow-none w-auto rounded-0">
                    ...
                    <a class="dropdown-item border-bottom-0 text-center btn-text fw-regular" href="notification.php">View All Notifications <i class="la la-arrow-right icon ml-1"></i></a>
                </div>
            </div><!-- end tab-pane -->
            <div class="tab-pane fade" id="user-profile-menu" role="tabpanel" aria-labelledby="user-profile-menu-tab">
                <div class="dropdown--menu shadow-none w-auto rounded-0">
                    <div class="dropdown-item-list">
                        ...
                        <a class="dropdown-item" href="notification"><i class="la la-bell mr-2"></i>Notifications</a>
