...
<div class="container">
    <form action="#" class="card card-item login-form" method="post" action="{{url('/')}}/login">
        @csrf
            ...
            <div class="col-lg-5 mx-auto">
                <div class="form-action-wrapper py-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control form--control" placeholder="Email address">
                    </div><!-- end form-group -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button id="send-message-btn" class="btn theme-btn w-100 text-white" type="submit">Log in <i class="la la-arrow-right icon ml-1"></i></button>
                    </div><!-- end form-group -->
