...
<div class="container">
    <form class="card card-item login-form" method="post" action="{{url('/')}}/login">
        @csrf
    ...
    <p class="text-black text-center fs-15">Dont have an account? <a href="{{route('layouts.signup')}}" class="text-color hover-underline">Sign up</a></p>
</div><!-- end container -->
</section>
<!--======================================
    END LOGIN AREA
