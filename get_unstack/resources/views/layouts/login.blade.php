...
<div class="container">
    <form action="#" class="card card-item login-form" method="post" id="loginform">
        <div class="card-body row p-0">
            <div class="col-lg-6">
                <div class="form-content py-4 pr-60px pl-60px border-right border-right-gray h-100 d-flex align-items-center justify-content-center">
                    <img src="assets/images/undraw-remotely.svg" alt="Image" class="img-fluid">
                </div>
            </div><!-- end col-lg-6 -->
            <div class="col-lg-5 mx-auto">
                <div class="form-action-wrapper py-5">
                    <div class="form-group">
                        <h3 class="fs-22 pb-3 fw-bold">Log in to GET-UNSTUCK</h3>
                        <div class="divider"><span></span></div>
                        <p class="pt-3">Enter your email address and login to your account.</p>
                    </div>
                    <div class="form-group">
                        <label class="fs-14 text-black fw-medium lh-18">Email</label>
                        <input type="text" name="user_name" class="form-control form--control" placeholder="Email address">
                    </div><!-- end form-group -->
                    <div class="form-group">
                        <label class="fs-14 text-black fw-medium lh-18">Password</label>
                        <div class="input-group">
                            <input class="form-control form--control password-field" type="password" name="user_password" placeholder="Password">
                            <div class="input-group-append">
                                <button class="btn theme-btn-outline theme-btn-outline-gray toggle-password" type="submit" name="login">
                    ...
                    <div class="form-group d-flex align-items-center justify-content-between">
                        ...
                        <a href="recoverpassword" class="btn-text fs-14 hover-underline fw-regular">Forgot Password?</a>
                    </div><!-- end form-group -->
                    <div class="form-group">
                        <button id="send-message-btn" class="btn theme-btn w-100 text-white" name="login" onclick="loginform()" type="submit">Log in <i class="la la-arrow-right icon ml-1"></i></button>
                    </div><!-- end form-group -->
                    <div class="social-icon-box">
                        ...
                        <button class="btn theme-btn twitter-btn d-flex align-items-center justify-content-center w-100" type="button">
                            ...
                            <span class="flex-grow-1">Log in with Twitter</span>
                        </button>
                    </div>
    ...
    <p class="text-black text-center fs-15">Dont have an account? <a href="signup" class="text-color hover-underline">Sign up</a></p>
</div><!-- end container -->
</section>
<!--======================================
    END LOGIN AREA
...
function loginform() {
    ...
    //console.log(header_for_post);
     ...
     fetch("http://localhost/blog-forum/API/loginuser", header_for_post).then(response => response.json()).then((res) => {
         console.log(res.Code);
         if(res.Code==1){
            console.log(res.Data);
            if (res.Data[0].role_id==1) {
                window.location.href="http://localhost/blog-forum/admindashboard";
            }else{
                window.location.href="http://localhost/blog-forum/home";
            }

         }
         else{
            window.location.href="http://localhost/blog-forum/login";
         }
        //data=  $.parseJSON(res)
