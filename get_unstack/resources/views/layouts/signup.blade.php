...
<div class="container">
    <form  class="card card-item" method="post" id="adduserform">
        <div class="card-body row p-0">
            <div class="col-lg-6">
                <div class="form-content p-5 h-100 d-flex align-items-center justify-content-center flex-column bg-diagonal-gradient-primary-2 radius-top-left-8 radius-bottom-left-8 text-left">
                    <h3 class="fs-35 pb-4 fw-bold text-white w-100">Join the Disilab Community</h3>
            ...
            <div class="col-lg-5 mx-auto">
                <div class="form-action-wrapper py-5">
                    <div class="form-group">
                        <h3 class="fs-22 pb-3 fw-bold">Sign up to Disilab</h3>
                        <div class="divider"><span></span></div>
                    </div>
                    <div class="form-group">
                        <label class="fs-14 text-black fw-medium lh-18">Display name</label>
                        <input type="text" name="user_name" class="form-control form--control" placeholder="Enter name">
                    </div><!-- end form-group -->
                    <div class="form-group">
                        <label class="fs-14 text-black fw-medium lh-18">Email</label>
                        <input type="email" name="user_email" class="form-control form--control" placeholder="Email address">
                    </div><!-- end form-group -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button id="send-message-btn" class="btn theme-btn w-100 text-white" type="submit" name="signup"  onclick="adduser()">Sign up <i class="la la-arrow-right icon ml-1"></i></button>
                    </div><!-- end form-group -->
...
function adduser(){
    ...
    //console.log(header_for_post);
     fetch("http://localhost/blog-forum/API/adduser", header_for_post).then(response => response.json()).then((res) => {
         console.log(res);
        if(res.Code==1){
            if(res.Code==1){
                window.location.href="http://localhost/blog-forum/login";
                 ...
                 window.location.href="http://localhost/blog-forum/signup";
         }
     })
}
</script>
