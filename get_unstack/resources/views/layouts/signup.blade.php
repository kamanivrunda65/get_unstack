...
<div class="container">
    <form  class="card card-item" method="post"  action="{{url('/')}}/signup">
        @csrf
            ...
            <div class="col-lg-5 mx-auto">
                <div class="form-action-wrapper py-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control form--control" placeholder="Enter name" value="{{old('name')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control form--control" placeholder="Email address" value="{{old('email')}}">
                        <span class="text-danger">
                            @error('email')
                                {{$message}}
                            @enderror
