                    ...
                    <div class="question-highlight">
                        <div class="media media-card shadow-none rounded-0 mb-0 bg-transparent p-0">
                            <div class="media-body">
                                <h5 class="fs-20"><a href="question-details.html">Unable to get data attribute from button element via Jquery</a></h5>
                            ...
                            <div class="comments-wrap">
                                <ul class="comments-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="comment-body">
                                            <span class="comment-copy">Your are missing quotes <code class="code">data-productI</code> Your markup breaks after that</span>
                                            <span class="comment-separated">-</span>
                                    ...
                                    <li>
                                        ...
                                        <div class="comment-body">
                                            <span class="comment-copy">This doesn't work either: <code class="code">data-productId=""</code>. @Kevin Martin</span>
                                            <span class="comment-separated">-</span>
                                            <a href="user-profile.html" class="comment-user owner" title="224,110 reputation">Arden Smith</a>
                                            <span class="comment-separated">-</span>
                                            <a href="#" class="comment-date">8 hours ago</a>
