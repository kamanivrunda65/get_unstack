...
<div class="container">
    <form class="card card-item login-form" method="post"  action="{{ route('login') }}">
        @csrf
            ...
            <div class="col-lg-5 mx-auto">
                <div class="form-action-wrapper py-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" value="{{ old('email') }}" required autocomplete="email" class="form-control form--control @error('email') is-invalid @enderror" placeholder="Email address" required autocomplete="email">
                        @error('email')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control form--control password-field @error('password') is-invalid @enderror" type="password" name="password" placeholder="Password" required autocomplete="current-password">
    ...
    <p class="text-black text-center fs-15">Dont have an account? <a href="{{route('register')}}" class="text-color hover-underline">Sign up</a></p>
</div><!-- end container -->
</section>
<!--======================================
    END LOGIN AREA
